...
export async function reverseGeocodeLocation(location: Location): Promise<string> {
  ...
  try {
    ...
    if (data.address) {
      ...
      } else if (addr.ISO3166_2_lvl4) {
        // フォールバック：ISO コードから都道府県を推定
        const prefCode: Record<string, string> = {
          ...
          'JP-21': '岐阜県', 'JP-22': '愛知県', 'JP-23': '三重県', 'JP-24': '滋賀県',
          'JP-25': '京都府', 'JP-26': '大阪府', 'JP-27': '兵庫県', 'JP-28': '奈良県',
          'JP-29': '和歌山県', 'JP-30': '鳥取県', 'JP-31': '島根県', 'JP-32': '岡山県',
          'JP-33': '広島県', 'JP-34': '山口県', 'JP-35': '徳島県', 'JP-36': '香川県',
          'JP-37': '愛媛県', 'JP-38': '高知県', 'JP-39': '福岡県', 'JP-40': '佐賀県',
          'JP-41': '長崎県', 'JP-42': '熊本県', 'JP-43': '大分県', 'JP-44': '宮崎県',
          'JP-45': '鹿児島県', 'JP-46': '沖縄県'
        }
        prefecture = prefCode[addr.ISO3166_2_lvl4] || ''
        if (prefecture) {
          console.log(`  ✓ State (from ISO): ${prefecture}`)
        }
      }
